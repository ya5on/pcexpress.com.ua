<template>
  <aside>
    <div id="aSidenav" class="sidenav" :class="{ active: navStatus }">
      <nuxt-link class="logo" to="/"><svg version="1.1" x="0px" y="0px" width="175.748px" height="42.52px" viewBox="0 0 175.748 42.52" enable-background="new 0 0 175.748 42.52" style="margin-bottom: 0;">
      ...
      <button class="closebtn" @click="toggleClass()">&times;</button>
      <nuxt-link  to="/">
        <span>Home</span>
      </nuxt-link>
